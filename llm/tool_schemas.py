                ...
                "properties": {
                    "queries": {
                        ...
                        "description": (
                            ...
                            "если клиент его указал. Если клиент уточнил один вариант кодом или ценой "
                            "после неоднозначного результата, ищи выбранное значение заново, а не отвечай "
                            "только по старому списку вариантов."
                        ),
                        "items": {
                            "type": "object",
                            "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "клиент просит человека, явно подтвердил показанный полный итог заказа, продолжает быть "
                "недоволен после исправления ответа, спрашивает "
                ...
                "Это ограничение действует для любой reason, включая product_selection и bot_uncertain."
            ),
            "parameters": {
                "type": "object",
                "properties": {
