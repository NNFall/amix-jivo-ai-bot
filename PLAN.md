...
- ??????: in progress.
- ????:
  - ???????????? ?????????? ?????? `https://amix-tk.ru/files/1C/prices.xml` ??? ???????? ???????? ?????????? ???? ???????;
  - ????????????? ????????? XML ? ????????????? ??? ? ???????????? ??????? ??????? ?????? 30 ????? ?? ?????????;
  - ???????? ?????? ???????? ? ??????? ??? ????????? ???????? ???????;
  - ???????? ?????? ?????? ?????????? ?? URL ?? ??????? ??? ???????? ??? ???????? ??????????.
- ??????:
  - ?? ?????? ?????? importer, ? ??????? ???? ? `data/incoming_xml/` ? ???????? ??? ? ???????????? `ProductXmlImporter`;
  - ????????? ??????? ? `.env`: URL, ????????? ???????????, ????????, ???????;
  - ? FastAPI lifespan ????????? ???? ??????? asyncio task ? ????????? ????????????? ??? ??? shutdown;
  - ?????? ??????????/??????? ??????????, ?? ????? ??????.
- ????????:
  - ???????? unit/integration tests ?? ??????????, ?????? endpoint ? ??????? ????;
  - ???????? ?????? pytest;
  - ?? VPS ????????? ?????? remote import ? ?????? ???????.
